...
-- Dumping data for table essentialmode.items: ~253 rows (approximately)
DELETE FROM `items`;
...
INSERT INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`, `price`, `id`, `limit`) VALUES
	...
	('chemicals', 'Chemicals', 2, 0, 1, 0, 0, '100'),
	...
	('hydrochloric_acid', 'HydroChloric Acid', 5, 0, 1, 0, 0, '15'),
	...
	('marijuana', 'marijuana', 10, 0, 1, 10, 94, '14'),
...
-- Dumping data for table essentialmode.jobs: ~24 rows (approximately)
DELETE FROM `jobs`;
...
INSERT INTO `job_grades` (`id`, `job_name`, `grade`, `name`, `label`, `salary`, `skin_male`, `skin_female`) VALUES
	...
	(75, 'garbage', 0, 'employee', 'Garbage Collection', 100, '{tshirt_1":59,"torso_1":89,"arms":31,"pants_1":36,"glasses_1":19,"decals_2":0,"hair_color_2":0,"helmet_2":0,"hair_color_1":0,"face":2,"glasses_2":0,"torso_2":1,"shoes":35,"hair_1":0,"skin":0,"sex":0,"glasses_1":19,"pants_2":0,"hair_2":0,"decals_1":0,"tshirt_2":0,"helmet_1":5}', '{}');
...
INSERT INTO `shops` (`id`, `store`, `item`, `label`, `price`) VALUES
	(1, 'TwentyFourSeven', 'bread', 'Bread', 30),
	(2, 'TwentyFourSeven', 'water', 'Water', 15),
	(5, 'LTDgasoline', 'bread', 'Bread', 30),
	(6, 'LTDgasoline', 'water', 'Water', 15),
	(7, 'TwentyFourSeven', 'phone', 'Phone', 2000),
	(9, 'LTDgasoline', 'chocolate', 'Chocolate', 10),
	(12, 'LTDgasoline', 'sandwich', 'Sandwich', 10),
	(13, 'TwentyFourSeven', 'hamburger', 'Hamburger', 15),
	(15, 'LTDgasoline', 'hamburger', 'Hamburger', 15),
	(16, 'TwentyFourSeven', 'cupcake', 'Cupcake', 10),
	(18, 'LTDgasoline', 'cupcake', 'Cupcake', 10),
	(19, 'TwentyFourSeven', 'chips', 'Chips', 15),
	(21, 'LTDgasoline', 'chips', 'Chips', 15),
	(22, 'TwentyFourSeven', 'cocacola', 'Cocacola', 15),
	(24, 'LTDgasoline', 'cocacola', 'Cocacola', 15),
	(25, 'TwentyFourSeven', 'icetea', 'Icetea', 10),
	(27, 'LTDgasoline', 'icetea', 'Icetea', 10),
	(28, 'TwentyFourSeven', 'coffe', 'Coffe', 10),
	(30, 'LTDgasoline', 'coffe', 'Coffe', 10),
	(46, 'Bar', 'beer', 'Beer', 150),
	(47, 'Bar', 'rhum', 'Rhum', 600),
	(53, 'Disco', 'beer', 'Beer', 150),
	(59, 'Disco', 'rhum', 'Rhum', 600),
	(64, 'LTDgasoline', 'phone', 'Phone', 2000),
	(65, 'RobsLiquor', 'vodka', 'Vodka', 200),
	(66, 'YouTool', 'c4_bank', 'C4', 2100),
	(67, 'YouTool', 'blowtorch', 'Blowtorch', 500),
	(68, 'YouTool', 'raspberry', 'Rasberry', 5000),
	(69, 'YouTool', 'fishbait', 'Fish-Bait', 100),
	(70, 'YouTool', 'fishingrod', 'Rod', 900),
	(71, 'YouTool', 'turtlebait', 'Turtlebait', 200),
	(72, 'Bar', 'vodka', 'Vodka', 200),
	(73, 'Disco', 'vodka', 'Vodka', 200),
	(74, 'RobsLiquor', 'beer', 'Beer', 150),
	(77, 'RobsLiquor', 'vodka', 'Vodka', 380),
	(81, 'RobsLiquor', 'rhum', 'Rum', 600),
	(82, 'YouTool', 'repairkit', 'Repair-kit', 2000),
	(83, 'YouTool', 'repairkit', 'Rod', 900),
	(84, 'YouTool', 'hackerDevice', 'Hacker-Device', 4000);
...
-- Dumping data for table essentialmode.trucks: ~243 rows (approximately)
DELETE FROM `trucks`;
/*!40000 ALTER TABLE `trucks` DISABLE KEYS */;
INSERT INTO `trucks` (`name`, `model`, `price`, `category`) VALUES
	('2014 Lamborghini Huracan', '1600000', 220000, 'icar'),
	('2018_Ford_F_350', '18f350ds', 220000, 'icar'),
	('2018 Chevrolet Camaro ZL1', '2018zl1', 400000, 'icar'),
	('2019 Audi A6 ', 'a6tfsi', 670000, 'icar'),
	...
	('MercedesC63', 'c63coupe', 320000, 'icar'),
	('Chevrolet Corvette C7', 'c7', 450000, 'icar'),
	('Camper', 'camper', 42000, 'vans'),
	('Caprice_Ls_2013', 'caprice13', 150000, 'icar'),
	('Carbonizzare', 'carbonizzare', 75000, 'sports'),
	('Carbon RS', 'carbonrs', 18000, 'motorcycles'),
	('Casco', 'casco', 30000, 'sportsclassics'),
	('Cavalcade', 'cavalcade2', 55000, 'suvs'),
	('2016 Porsche Cayenne Turbo S', 'cayenne', 200000, 'icar'),
	...
	('2019 Rolls Royce Dawn', 'dawn', 720000, 'icar'),
	...
	('Ford Mustang Hoonicorn', 'fordh', 95000, 'icar'),
	...
	('GMC Yukon Denali 2015', 'gmcyd', 300000, 'icar'),
	('Cadillac Escalade GMT900', 'gmt900escalade', 310000, 'icar'),
	...
	('2004_Mustang_Cobra', 'mgt', 600000, 'icar'),
	...
	('2019 Lamborghini SC18 Alston', 'sc18', 1800000, 'icar'),
	...
	('2016 Chevrolet Suburban', 'subn', 320000, 'icar'),
	...
	('Declasse Drift Tampa V2', 'tampa3', 160000, 'icar'),
	...
	('Dodge Viper SRT', 'viper', 450000, 'icar'),
...
-- Dumping data for table essentialmode.truck_categories: ~12 rows (approximately)
...
INSERT INTO `twitter_tweets` (`id`, `authorId`, `realUser`, `message`, `time`, `likes`) VALUES
	(1, 1, 'steam:11000013d80c34f', 'HI', '2020-06-30 11:26:56', 0);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `house` varchar(800) COLLATE utf8mb4_bin NOT NULL DEFAULT '{"owns":false,"furniture":[],"houseId":0}',
  `bought_furniture` varchar(800) COLLATE utf8mb4_bin NOT NULL DEFAULT '{}',
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
-- Dumping data for table essentialmode.vehicles: ~243 rows (approximately)
DELETE FROM `vehicles`;
/*!40000 ALTER TABLE `vehicles` DISABLE KEYS */;
INSERT INTO `vehicles` (`name`, `model`, `price`, `category`, `inshop`, `stock`) VALUES
	('DodgeChargerSRT', '16charger', 220000, 'super', 0, 0),
	('Adder', 'adder', 900000, 'super', 0, 10),
	('Akuma', 'AKUMA', 7500, 'importbikes', 0, 10),
	('Alpha', 'alpha', 60000, 'importcars', 0, 10),
	('Ardent', 'ardent', 1150000, 'importcarsclassics', 1, 10),
	...
	('blazer5', 'blazer5', 1755600, 'importcars', 1, 10),
	('Blista', 'blista', 8000, 'importcars', 0, 10),
	('BMWS', 'bmws', 220000, 'super', 0, 0),
	...
	('Dune Buggy', 'dune', 8000, 'importcars', 1, 10),
	...
	('FerrariF40', 'f40', 220000, 'super', 0, 0),
	...
	('Vespa', 'faggio2', 2800, 'importbikes', 1, 10),
	...
	('The Liberator', 'monster', 210000, 'importcars', 1, 0),
	...
	('Pfister', 'pfister811', 85000, 'importcars', 1, 0),
	...
	('rmodpagani', 'rmodpagani', 220000, 'super', 0, 0),
	...
	('Savestra', 'savestra', 990000, 'importcarsclassics', 1, 0),
	...
	('Shotaro Concept', 'shotaro', 320000, 'importbikes', 1, 0),
	...
	('Turismo R', 'turismor', 350000, 'importcars', 1, 0),
	('Tyrus', 'tyrus', 600000, 'importcars', 0, 0),
	('Urus 2018', 'urus2018', 220000, 'suvs', 0, 0),
	...
	('Viseris', 'viseris', 875000, 'importcarsclassics', 1, 0),
	('Visione', 'visione', 2250000, 'importcars', 0, 0),
	('Voltic', 'voltic', 90000, 'importcars', 1, 0),
...
INSERT INTO `vehicle_display` (`id`, `model`, `name`, `commission`, `downpayment`) VALUES
	...
	(3, '16charger', 'DodgeChargerSRT', 10, 25),
	(4, 'f40', 'FerrariF40', 10, 25),
	(5, 'bmws', 'BMWS', 10, 25),
	(6, 'rmodpagani', 'rmodpagani', 10, 25),
	(7, 'urus2018', 'Urus 2018', 10, 25),
...
-- Dumping data for table essentialmode.weashops: ~8 rows (approximately)
DELETE FROM `weashops`;
/*!40000 ALTER TABLE `weashops` DISABLE KEYS */;
INSERT INTO `weashops` (`id`, `name`, `item`, `price`) VALUES
	(1, 'GunShop', 'WEAPON_PISTOL', 650),
	(3, 'GunShop', 'WEAPON_FLASHLIGHT', 500),
	(6, 'BlackWeashop', 'WEAPON_MACHETE', 600),
	(9, 'GunShop', 'WEAPON_BAT', 1100),
	(11, 'GunShop', 'WEAPON_STUNGUN', 2600),
	(14, 'BlackWeashop', 'WEAPON_MICROSMG', 65000),
	(15, 'GunShop', 'WEAPON_PUMPSHOTGUN', 8000),
