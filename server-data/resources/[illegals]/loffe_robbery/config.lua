...
Config.Shops = {
    ...
    {coords = vector3(24.03, -1345.63, 29.5-0.98), heading = 266.0, money = {3000, 5000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 20, second = 0}, robbed = false},
    {coords = vector3(-3038.38, 584.75, 7.91-0.98), heading = 17.24, money = {3000, 5000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 20, second = 0}, robbed = false},
    {coords = vector3(-1221.52,-907.99, 12.33-0.98), heading = 32.81, money = {3000, 5000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 20, second = 0}, robbed = false},
    {coords = vector3(1164.59, -322.16, 69.21-0.98), heading = 97.08, money = {3000, 5000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 20, second = 0}, robbed = false},
    {coords = vector3(1727.62, 6414.73, 35.04-0.98), heading = 243.2, money = {3000, 5000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 20, second = 0}, robbed = false},
    {coords = vector3(372.44, 325.91, 103.57-0.98), heading = 256.38, money = {3000, 5000}, cops = 2, blip = true, name = 'Store Robbery', cooldown = {hour = 0, minute = 20, second = 0}, robbed = false},
