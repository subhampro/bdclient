Config = {}
	...
	Config.FishPrice = {a = 500, b = 700} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 5000, b = 7000} --Will get dirty money
	Config.SharkPrice = {a = 8000, b = 9000} --Will get dirty money
