...
Config.PoliceVehicles = {
	{ model = 'pd8', label = 'Cruiser', price = 0 },
	{ model = 'pd9', label = 'Impala', price = 0 },
	{ model = 'pd2', label = 'Charger', price = 0 },
	{ model = 'pd', label = 'Dodge Charger', price = 0 },
	{ model = 'pd4', label = 'Taurus', price = 0 },
	{ model = 'pd5', label = 'Tahoe', price = 0 },
	{ model = 'pd3', label = 'Laramie', price = 0 },
	{ model = 'pd6', label = 'Silverado', price = 0 },
	{ model = 'hcbr500rgn', label = 'Police Bike', price = 0 },
	{ model = 'pd10', label = 'Explorer', price = 0 }
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'polmav', label = 'Police Maverick', livery = polmav_sign_1, price = 0 }
}

-- Police Boats:
Config.PoliceBoats = {
	{ model = '', label = 'Police Predator', livery = 0 , price = 0 }
}
