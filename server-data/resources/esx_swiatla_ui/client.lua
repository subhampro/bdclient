...
AddEventHandler("esx_swiatla:otworz", function()
	...
	if IsPedInVehicle(ped, car, false) then
		...
		ESX.ShowAdvancedNotification('of Light', '', "~y~You must sit in the car to change the color of the lights", pic, 1)
	end
end)
...
RegisterNUICallback('save', function(data, cb)
	...
	ESX.TriggerServerCallback("esx_swiatla:zapisz_swiatla", function(isPurchasable)
		if isPurchasable then
			ESX.ShowAdvancedNotification('of Light', '', "~y~The bulbs were installed", pic, 1)
		else
			ESX.ShowAdvancedNotification('of Light', '', "~y~Error occured", pic, 1)
		end
